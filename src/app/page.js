        ...
        <div>
          ...
          <div className="mt-4 ">
            <p className="text-text-secondary text-left leading-7 font-normal">
              ...
              wand. With MongoDB, Express.js, React, Node.js, and the wizardry
              of Next.js in my arsenal, I conjure up web applications that
              dazzle and delight. From sleek interfaces to seamless server-side
              rendering, I specialize in crafting experiences that leave users
              spellbound. Let&apos;s collaborate to transform your visions into
